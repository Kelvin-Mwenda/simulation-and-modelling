...
class Automobile:
    # The __init__ method accepts arguments for the make, model, milieage, and price. It initializes the data attributes with these values.
...
class Car(Automobile):
    # The __init__ method accepts arguments for the car's make, model, price, and doors.

    def __init__(self, make, model, mileage, price, doors):
        # Call the superclass's _init__ method and pass the required arguments. Note that we also have to pass self as an argument.
...
class SUV(Automobile):
    ...
    # The get_pass_cap method is the accessor for the attribute.
